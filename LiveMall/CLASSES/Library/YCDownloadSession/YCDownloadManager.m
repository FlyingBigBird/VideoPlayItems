...
+ (void)startDownloadWithUrl:(NSString *)downloadURLString fileName:(NSString *)fileName fileType:(NSString *)fileType imageUrl:(NSString *)imagUrl {
    
    [YCDownloadMgr startDownloadWithUrl:downloadURLString fileName:fileName fileType:fileType imageUrl:imagUrl];
}

+ (void)startDownloadWithUrl:(NSString *)downloadURLString fileName:(NSString *)fileName fileType:(NSString *)fileType imageUrl:(NSString *)imagUrl fileId:(NSString *)fileId {
    
    [YCDownloadMgr startDownloadWithUrl:downloadURLString fileName:fileName fileType:fileType imageUrl:imagUrl fileId:fileId];
}
...
+ (NSArray *)downloadingList {
    ...
    return [YCDownloadMgr downloadingList];
}
...
+ (NSUInteger)getCacheSize {
    ...
    return [YCDownloadMgr getCacheSize];
}
...
- (void)startDownloadWithUrl:(NSString *)downloadURLString fileName:(NSString *)fileName fileType:(NSString *)fileType imageUrl:(NSString *)imagUrl {
    ...
    [self startDownloadWithUrl:downloadURLString fileName:fileName fileType:fileType imageUrl:imagUrl fileId:downloadURLString];
}
...
- (void)startDownloadWithUrl:(NSString *)downloadURLString fileName:(NSString *)fileName fileType:(NSString *)fileType imageUrl:(NSString *)imagUrl fileId:(NSString *)fileId {
    ...
    //修复NSURLSessionTaskPriorityDefault iOS 8.2闪退的bug
    [self startDownloadWithItem:item priority:0.5];//NSURLSessionTaskPriorityDefault
}
