//
//  GZIMGCDTimerHelper.m
//  GZIMClient
//
//  Created by kuo zheng  on 2017/11/2.
//  Copyright © 2017年 呱呱开放平台. All rights reserved.
//

#import "GZIMGCDTimerHelper.h"

@interface GZIMGCDTimerHelper()
...
@implementation GZIMGCDTimerHelper

#pragma mark - Public Method

+ (GZIMGCDTimerHelper *)sharedInstance {
    static GZIMGCDTimerHelper *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[GZIMGCDTimerHelper alloc] init];
    });
