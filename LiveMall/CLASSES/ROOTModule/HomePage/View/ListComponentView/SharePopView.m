...
;
        ...
        splitLine.backgroundColor = RGBA(255.0, 255.0, 255.0, 0.1)
;
        ...
        [_cancel setTitleColor:GWhiteColor forState:UIControlStateNormal];
        _cancel.titleLabel.font = Font(16);

        _cancel.backgroundColor = GGrayColor;
...
- (void)onActionItemTap:(UITapGestureRecognizer *)sender {
    ...
    [self.delegate actionClickedAtIndex:sender.view.tag];
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _icon.image = [UIImage imageNamed:@"football"];
        ...
        _label.text = @"TEXT";
        _label.textColor = RGBA(255.0, 255.0, 255.0, 0.6);
        _label.font = Font(14);
