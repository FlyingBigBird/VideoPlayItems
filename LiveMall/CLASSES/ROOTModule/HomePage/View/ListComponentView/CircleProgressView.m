...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if(self) {
        self.layer.backgroundColor = RGBA(0.0, 0.0, 0.0, 0.4).CGColor;
        self.layer.borderColor = RGBA(255.0, 255.0, 255.0, 0.8).CGColor;
        self.layer.borderWidth = 1.0f;
        
        _progressLayer = [CAShapeLayer new];
        _progressLayer.fillColor = RGBA(255.0, 255.0, 255.0, 0.8).CGColor;
