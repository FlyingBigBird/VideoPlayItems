...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if(self) {
        ...
        _textView.backgroundColor = GClearColor;
        
        _textView.clipsToBounds = NO;
        _textView.textColor = GWhiteColor;
        ...
        _placeholderLabel.textColor = RGBA(255.0, 255.0, 255.0, 0.4);
        _placeholderLabel.font = Font(16);
        _placeholderLabel.frame = CGRectMake(kHoverTextViewLeftInset, 0, SCREEN_WIDTH - kHoverTextViewLeftInset - kHoverTextViewRightInset, 50);
        ...
        _splitLine.backgroundColor = RGBA(255.0, 255.0, 255.0, 0.4);
...
-(void)textViewDidChange:(UITextView *)textView {
    ...
    if(!textView.hasText) {
        ...
        _textHeight = [attributedText multiLineSize:SCREEN_WIDTH - kHoverTextViewLeftInset - kHoverTextViewRightInset].height;
    }
    [self updateViewFrameAndState];
}
...
- (UIView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event {
    ...
    if(hitView == self){
        if(hitView.backgroundColor == GClearColor) {
            return nil;
        }
    }
    return hitView;
